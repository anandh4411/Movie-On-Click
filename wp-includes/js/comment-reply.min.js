...
window.addComment = (function (u) {
    var v,
        ...
        p,
        f = u.document,
        I = { commentReplyClass: "comment-reply-link", cancelReplyId: "cancel-comment-reply-link", commentFormId: "commentform", temporaryFormId: "wp-temp-form-div", parentIdFieldId: "comment_parent", postIdFieldId: "comment_post_ID" },
    ...
    return (
        i && "loading" !== f.readyState ? t() : i && u.addEventListener("DOMContentLoaded", t, !1),
        {
            init: r,
            moveForm: function (e, t, n, r) {
                ...
                if (d && p && m) {
                    (l = p),
                        (e = I.temporaryFormId),
                        (n = h(e)) || (((n = f.createElement("div")).id = e), (n.style.display = "none"), l.parentNode.insertBefore(n, l)),
                        r && c && (c.value = r),
                        (m.value = t),
                        (v.style.display = ""),
                    ...
                    try {
                        for (var s = 0; s < y.elements.length; s++)
                            if (
                                ((o = y.elements[s]),
                                (i = !1),
                                "getComputedStyle" in u ? (a = u.getComputedStyle(o)) : f.documentElement.currentStyle && (a = o.currentStyle),
